...
if (!isset($payment_data) || !is_array($payment_data)) {
    die("Error: Payment data is not available");
}
        ...
        <div class="content">
            <div class="receipt-details">
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-value"><?php echo htmlspecialchars($payment_data['mobile']); ?></div>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-value"><?php echo htmlspecialchars($payment_data['description']); ?></div>
                </div>
                <div class="detail-row">
                    <div class="detail-label">Reference ID</div>
                    <div class="detail-value"><?php echo htmlspecialchars($payment_data['reference_1']); ?></div>
                </div>
                <div class="detail-row">
                    <div class="detail-label">Payment Type</div>
                    <div class="detail-value"><?php echo htmlspecialchars($payment_data['reference_2']); ?></div>
                </div>
            </div>
            ...
            <div class="summary">
                ...
                <div class="detail-row">
                    ...
                    <span class="value"><?php echo htmlspecialchars($payment_data['DateCreated']); ?></span>
                </div>
                <div class="detail-row">
            ...
            <div style="text-align: center; margin-top: 20px;">
                <button class="btn btn-primary" onclick="window.location.href='/module-auth/login.php'">Back to Home </button>
